                ...
                {account && (
                    <div className="relative">
                        <button
                            ...
                            className="cursor-pointer py-2 px-4 rounded-lg bg-gray-600 hover:bg-gray-500 focus:outline-none flex items-center gap-2 w-38"
                        >
                            <div>
                            ...
                            <p className="block text-xl truncate">
                                {account}
                            </p>
                        </button>
                        {isMenuOpen && (
